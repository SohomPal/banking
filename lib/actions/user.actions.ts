...
const {
  APPRWRITE_DATABSE_ID: DATABASE_ID,
...
export async function getLoggedInUser() {
  ...
  export const logoutAccount = async() => {
    try {
        ...
        await account.deleteSession('curret');
    } catch (error) {
        return null;
    }
  }
  ...
  export const exchangePublicToken = async({
    ...
    try {
      ...
      //If funding source URL is not found throw an error
      if(!fundingSourceURL) throw Error;

      //Create bank account using releavant info
